...
const Distributor = (props) => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                // Make an API request to fetch data for the specific Distributor
    ...
    // NOTE: agr sirf Distributor ko delete kr dia to to uski entries data base mein reh jayein gi 
    ...
    const handleDelete = async (itemId) => {
        ...
        try {
            if (confirmDelete) {
                ...
                // This try catch will first delete the all the entries of the Distributor and then delete the Distributor 
                try {
                    const response = await axios.delete(`/api/admin/deleteEntries/${itemId}`)
