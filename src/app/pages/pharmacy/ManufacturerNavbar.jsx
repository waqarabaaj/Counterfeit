...
const ManufacturerNavbar = ({ name }) => {
    ...
    return (
        ...
        <BsFillHospitalFill className="text-4xl text-blue-500" /> */}
            ...
            <div className="flex items-center justify-center space-x-6 mx-2 px-2">
                ...
                <div className="flex flex-col gap-2 items-center mt-6">
                    <p className="text-center">GSRN</p>
                    <FaPerson className="text-4xl text-green-500 transform transition-transform hover:scale-125" />
                    <p className="text-center">Consumer</p>
                    <p className="text-center">Patitent</p>
                </div>
